...
import (
	...
	characterservicesvr "assignment_crossnokaye/cod/characterservice/gen/grpc/characterservice/server"
	"context"
	"log"
	"net"
	"net/url"
...
func handleGRPCServer(ctx context.Context, u *url.URL, characterserviceEndpoints *characterservice.Endpoints, wg *sync.WaitGroup, errc chan error, logger *log.Logger, debug bool) {
	...
	characterservicepb.RegisterCharacterserviceServer(srv, characterserviceServer)
