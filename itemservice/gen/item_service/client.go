...
// Create calls the "Create" endpoint of the "ItemService" service.
...
// Get calls the "Get" endpoint of the "ItemService" service.
// Get may return the following errors:
//   - "not_found" (type NotFound)
//   - error: internal error
func (c *Client) Get(ctx context.Context, p *GetPayload) (res *Item, err error) {
	var ires any
...
// Update calls the "Update" endpoint of the "ItemService" service.
...
// Delete calls the "Delete" endpoint of the "ItemService" service.
